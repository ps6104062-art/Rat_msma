...
async def listen_for_codes(phone: str, session_file: str, callback, timeout: int = 300):
    ...
    try:
        await client.start()
        # 777000 — стандартный Telegram (коды входа)
        # 42777  — Telegram Service Notifications (+42777)
        code_filter = filters.user(777000) | filters.user(42777)
        client.add_handler(MessageHandler(on_message, code_filter))
